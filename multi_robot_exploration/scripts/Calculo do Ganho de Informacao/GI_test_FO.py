...
#---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def map_callback(self, msg):
        ...
        map_type = 1
        resolution = 0.05
        frontier_robot = self.calculate_frontier_information_gain(cluster_points, resolution)
        ...
        print("Goal Point x = ",goal_point.point.x)
        print("Goal Point y = ",goal_point.point.y)
    ...
    #----------------------------------------------------------------------------------------------------------------
    def calculate_frontier_information_gain(self, cluster_points, resolution):
        table = []
