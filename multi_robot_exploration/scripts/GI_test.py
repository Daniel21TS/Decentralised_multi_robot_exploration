...
#---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def map_callback(self, msg):
        ...
        for data in frontier_robot:
            ...
            print("size={}, distance={}, x={}, y={} ".format(size, distance, middle_point.point.x , middle_point.point.y ))
        ...
        if self.last_goal_point_1 == 0:
            ...
            for data in frontier_robot:
                size, distance, middle_point = data
                if middle_point.point.x == self.last_goal_point_1.point.x and distance > 1.0:
                    check = 1
